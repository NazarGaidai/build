  ...
  (s.scope = {}),
    ...
    (s.polyfill = function (t, a, e, r) {
      if (a) {
        ...
        (a = a((r = e[(t = t[t.length - 1])]))) != r &&
          null != a &&
          s.defineProperty(e, t, { configurable: !0, writable: !0, value: a });
      }
    }),
    s.polyfill(
    ...
    (t = function (t) {
      var a = function (a, e, s) {
        var r = {
          ...
          events: function () {
            a.on("keydown.mask", function (t) {
              a.data("mask-keycode", t.keyCode || t.which),
                ...
                a.data("mask-previus-caret-pos", r.getCaret()),
              ...
              .on("blur.mask", function () {
                o === r.val() || a.data("changed") || a.trigger("change"),
                  a.data("changed", !1);
              })
              .on("blur.mask", function () {
                o = r.val();
          ...
          calculateCaretPosition: function (t) {
            ...
            if (t !== e) {
              ...
              s > o
                ? (s = 10 * e)
                : n >= s && n !== o
                ? r.maskDigitPosMapOld[s] ||
                  ((n = s),
                  (s = s - (p - c) - t),
                  r.maskDigitPosMap[s] && (s = n))
                : s > n && (s = s + (c - p) + l);
            }
            return s;
          },
          ...
          getMasked: function (t, a) {
            ...
            return (
              (t = e.charAt(v)),
              p !== u + 1 || i.translation[t] || o.push(t),
              (o = o.join("")),
              r.mapMaskdigitPositions(o, a, u),
              o
            );
          },
          mapMaskdigitPositions: function (t, a, e) {
            for (
              t = s.reverse ? t.length - e : 0, r.maskDigitPosMap = {}, e = 0;
              e < a.length;
              e++
            )
          ...
          callbacks: function (t) {
            ...
            c("onChange", !0 === i, l),
              c("onKeyPress", !0 === i, l),
              c("onComplete", n.length === e.length, l),
              c("onInvalid", 0 < r.invalid.length, [n, t, a, r.invalid, s]);
          },
        };
        a = t(a);
        var n,
        ...
        (e = "function" == typeof e ? e(r.val(), void 0, a, s) : e),
          ...
          (i.init = function (o) {
            if (
              ...
              s.placeholder && a.attr("placeholder", s.placeholder),
      ...
      var e = function () {
          var e = t(this),
            ...
            n = e.attr("data-mask");
          if (
            (e.attr("data-mask-reverse") && (r.reverse = !0),
            e.attr("data-mask-clearifnotmatch") && (r.clearIfNotMatch = !0),
        ...
        s = function (a, e, s) {
          ...
          try {
            return (
              ...
              "object" != typeof r || n(r.options) !== n(s) || r.mask !== e
            );
          } catch (t) {}
        },
        r = function (t) {
      ...
      (t.fn.mask = function (e, r) {
        ...
        (r = t.jMaskGlobals = t.extend(!0, {}, r, t.jMaskGlobals)).dataMask &&
          t.applyDataMask(),
    ...
    (t = jQuery),
      ...
      (e = {
        ...
        deleteProducts: function (a, s) {
          let r = t("<button>")
            .attr({ class: "smart-basket__product-delete" })
        ...
        showProducts: function (s) {
          let r = t("<form>").attr({
            ...
            i = t("<div>")
              .attr({ class: "smart-basket__product-id" })
              .text("ID"),
            o = t("<div>")
              .attr({ class: "smart-basket__product-name" })
              .text("Товар"),
            l = t("<div>")
              .attr({
                class:
                  "smart-basket__product-quantity smart-basket__product-quantity_header",
              })
              .text("Кількість"),
            c = t("<span>")
              .attr({ class: "smart-basket__info-icon" })
              .text("?"),
            p = t("<button>")
              .attr({ class: "smart-basket__info-msgs-close" })
              .text("×"),
            d = t("<span>")
              .attr({ class: "smart-basket__info-msgs" })
              .html("Ціна за 1 товар")
              .append(p),
            u = t("<div>")
              .attr({ class: "smart-basket__product-price" })
              .html(`Ціна / ${a.smartBasketCurrency}`)
              .append(c)
              .append(d);
          c.click(() => {
            d.fadeToggle();
          ...
          let m = t("<div>")
              .attr({ class: "smart-basket__product-price-common" })
              .html(`Загальна ціна / ${a.smartBasketCurrency}`),
            k = t("<div>")
              .attr({ class: "smart-basket__product-delete" })
              .text("Видалити");
          n.append(o).append(i).append(u).append(l).append(m).append(k),
            r.append(n);
          for (let n in s) {
            let i = t("<div>").attr({ class: "smart-basket__product-item" }),
              ...
              b = t("<button>")
                .attr({ class: "smart-basket__add-item" })
                .text("+"),
              f = t("<button>")
                .attr({ class: "smart-basket__remove-item" })
                .text("-"),
              v = t("<input>").attr({
            ...
            for (let a in s[n]) {
              ...
              if (
                ("sbName" === a &&
                  (c.append(`<span>${s[n][a]}</span>`), p.val(s[n][a])),
                "sbSize" === a &&
                  void 0 !== s[n][a] &&
                  (c
                    .children("span")
                    .append(
                      `<span class="smart-basket__product-size"> Розмір: ${s[n][a]}</span>`
                    ),
                  d.val(s[n][a])),
            ...
            f.click(function (a) {
              ...
              n > 1 &&
                ((o = i * --n),
                k.val(n),
                e.updateBasket(s, r, n, o),
                e.getSmartBasketMinState(s, "updateSmartBasketMin"),
              ...
              g.append(y),
              r.append(
                i.append(c).append(o).append(_).append(m).append(g).append(M)
              );
          }
        ...
        stateBasket: function () {
          ...
          if (
            (localStorage.getItem(a.localStorageName),
            l.append(e.showProducts(o)),
            a.productQuantityWrapper)
          ) {
          ...
          } else console.log("Заповніть параметри productSize і productPrice");
          return (
            ...
            c.click(function () {
              ...
              if (void 0 !== r[n]) {
                let a = t(this).html();
                return (
                  t(this).text("Товар вже в кошику"),
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            i = 0,
            o = t("<div>")
              .attr({ class: "smart-basket__empty-title" })
              .text("Кошик порожній.Ви не додали жодного товару")
              .fadeOut(),
            l = t("<div>")
              .attr({ class: "smart-basket__success-title" })
              .text("Замовлення прийняте.Чекайте дзвінка")
              .css("display", "none"),
          ...
          for (let t in e)
            for (let a in e[t])
              "sbQuantity" === a && (n += +e[t][a]),
                "sbPriceCommon" === a && (i += +e[t][a]);
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                d.html(`<span>Загально товарів: </span> ${n}`),
                p.html(
                  `<span>Загальна вартість: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                    2
                  )} ${a.smartBasketCurrency}">`
                ),
                c.append(o).append(l).append(d).append(p),
                c
              );
            0 == +n && t("." + o.attr("class")).css("display", "block"),
              t("." + d.attr("class")).html("<span>Загально товарів: </span> "),
              t("." + d.attr("class")).html(
                `<span>Загально товарів: </span> ${n}`
              ),
        ...
        getSmartBasketMinState: function (s, r) {
          ...
          a.smartBasketMinText &&
            i.prepend(
              `<span class="smart-basket__min-text">${a.smartBasketMinText}</span> `
            );
          let o = t("<img>").attr({
          ...
          r
            ? (t("." + l.attr("class")).html(""),
              t("." + l.attr("class")).html(n))
            : (l.html(n),
              t("." + a.smartBasketMinArea).append(i.append(o).append(l))),
            e.getModalBasket(i, s);
        },
        ...
        userForm: function () {
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            let e = t("<label>").attr({
              ...
              s = t("<input>").attr({
                ...
                value: "Я приймаю умови договору користувача",
              }),
              r = null;
            (r = a.agreement.isLink
              ? t("<a>").attr({
              ...
              s.is(":checked")
                ? r.text("Я приймаю умови договору користувача")
                : r.text("Я не приймаю умови договору користувача"),
              e.click(function () {
                s.is(":checked")
                  ? (r.text(
                      "Я не приймаю умови договору користувача"
                    ),
                    s.val("Я не приймаю умови договору користувача"),
                    m.attr({ disabled: "disabled" }),
                    d.addClass("smart-basket__input-wrapper_error"))
                  : (r.text("Я приймаю умови договору користувача"),
                    s.val("Я приймаю умови договору користувача"),
                    m.attr({ disabled: !1 }),
          ...
          let u = t("<button>")
            .attr({ class: "smart-basket__close-form" })
            ...
            m.click(function (t) {
              ...
              if (a.nameIsRequired && a.telIsRequired && a.emailIsRequired) {
                if ("" === l.val() || "" === i.val() || "" === p.val() || r(s))
                  return (
                    "" === l.val() &&
                      l.parent().addClass("smart-basket__input-wrapper_error"),
                    "" === i.val() &&
                      i.parent().addClass("smart-basket__input-wrapper_error"),
                    "" === p.val() &&
                      p.parent().addClass("smart-basket__input-wrapper_error"),
                    !1
                  );
                e.sendCart();
                ...
                if (
                  "" === i.val() ||
                  !(
                    ("" !== l.val() && a.telIsRequired) ||
                    ("" !== p.val() && a.emailIsRequired)
                  ) ||
                  r(s)
                )
                  return (
          ...
          let b = (a) => {
            a.focus(function () {
              ...
              a.blur(function () {
                t(this)
                  .parent()
                  .removeClass("smart-basket__input-wrapper_focus"),
                  "" === this.value &&
                    t(this)
                      .parent()
                      .addClass("smart-basket__input-wrapper_error");
              }),
              ...
              a.change(function () {
                t(this)
                  .parent()
                  .removeClass("smart-basket__input-wrapper_error"),
                  t(this)
                    .parent()
                    .addClass("smart-basket__input-wrapper_focus");
              });
          };
          ...
          t.ajax({
            ...
            complete: function (s) {
              ...
              e.commonResult(r, "", "submitEvent"),
                localStorage.clear(),
                "" !== a.yaCounter.counterID &&
                  "" !== a.yaCounter.targetID &&
                  ym(a.yaCounter.counterID, "reachGoal", a.yaCounter.targetID),
                setTimeout(() => {
                  t(".smart-basket").toggleClass("smart-basket_active"),
                    t("body").css("overflow", "auto");
                }, 3e3),
      ...
      (t.fn.smbasket = function (a) {
        return e[a]
          ...
          : "object" != typeof a && a
          ? void t.error("Метод " + a + " не найден")
