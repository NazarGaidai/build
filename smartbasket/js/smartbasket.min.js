        ...
        showProducts: function (s) {
          let r = t("<form>").attr({
            ...
            d = t("<span>")
              ...
              .html("Цена за 1 товар или услугу")
              .append(p),
            u = t("<div>")
              .attr({ class: "smart-basket__product-price" })
              .html(`Цена / ${a.smartBasketCurrency}`)
              .append(c)
              .append(d);
          c.click(() => {
            d.fadeToggle();
              ...
              if (
                ...
                "sbSize" === a &&
                  ...
                  (c
                    .children("span")
                    .append(
                      `<span class="smart-basket__product-size"> Размер: ${s[n][a]}</span>`
                    ),
                  d.val(s[n][a])),
          ...
          return (
            ...
            c.click(function () {
              ...
              if (void 0 !== r[n]) {
                let a = t(this).html();
                return (
                  t(this).text("Товар уже в корзине"),
        ...
        commonResult: function (e, s, r) {
          let n = 0,
            ...
            o = t("<div>")
              ...
              .text("Корзина пуста. Вы не добавили ни одного товара")
              .fadeOut(),
            l = t("<div>")
              .attr({ class: "smart-basket__success-title" })
              .text("Заказ принят. Ожидайте звонка")
              .css("display", "none"),
          ...
          if ((0 == +n ? o.fadeIn() : o.fadeOut(), r))
            ...
            if (!s)
              return (
                ...
                p.html(
                  `<span>Общая стоимость: </span> <input name="finalPrice" class="smart-basket__total-cost" type="text" value="${i.toFixed(
                    2
        ...
        userForm: function () {
          ...
          if ((c.append(p), a.agreement.isRequired)) {
            ...
            (r = a.agreement.isLink
              ...
              s.is(":checked")
                ? r.text("Я принимаю условия пользовательского соглашения")
                : r.text("Я не принимаю условия пользовательского соглашения"),
              e.click(function () {
                s.is(":checked")
                  ? (r.text(
                      "Я не принимаю условия пользовательского соглашения"
                    ),
